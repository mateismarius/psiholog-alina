...
const contactInfo = [
    ...
    },
    {
        icon: Mail,
        title: 'Email',
        info: 'contact@psiholog-alina.ro',
        link: 'mailto:contact@psiholog-alina.ro',
            ...
            <section className="py-20 bg-gradient-to-br from-therapeutic-600 via-therapeutic-500 to-calming-500 text-white relative overflow-hidden">
                ...
                <Container className="relative z-10">
                    <AnimatedSection animation="fadeIn" className="text-center max-w-4xl mx-auto">
                        ...
                        <Typography variant="h1" className="text-white mb-6" family="serif">
                            Contactează-mă pentru o
                            <span className="block text-warm-200">Consultație Gratuită</span>
                        </Typography>
